...
export default async function Image({ params }: { params: Promise<{ slug: string; side: string }> }) {
  ...
  return ogImage(<StartupOg startup={loaded.startup} market={loaded.market} intent={side} icon={icon} />);
}
