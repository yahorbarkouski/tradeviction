...
export const GALLERY_CASES: GalleryCase[] = [
  ...
  marketCase({
    ...
    market: market({
      long: 11,
      short: 14,
      series: [null, null, 0.5, 0.48, 0.46, 0.45, 0.44],
      delta: -6,
      hotness: 22,
      comments: 1,
    }),
  ...
  marketCase({
    ...
    market: market({
      long: 412,
      short: 13,
      series: [0.95, 0.96, 0.96, 0.97, 0.97, 0.97, 0.97],
      delta: 1,
      hotness: 88,
      comments: 240,
    }),
  ...
  marketCase({
    ...
    market: market({
      long: 58,
      short: 4,
      series: [0.86, 0.88, 0.9, 0.9, 0.91, 0.9, 0.91],
      delta: 5,
      hotness: 40,
      comments: 22,
    }),
  ...
  partyCase({
    ...
    members: 2,
    rows: [
      member(1, "mantegna", 8.2, [
        bet("Perplexity", "perplexity.ai", "short", 40),
        bet("Mistral", "mistral.ai", "long", 10),
      ]),
      member(2, "erin", -1.5, [bet("Cursor", "cursor.com", "short", 20)]),
    ],
  }),
  partyCase({
    id: "party-empty",
  ...
  partyCase({
    ...
    rows: [
      member(1, "alice", 4, [
        bet("Quietfold", "quietfold.example", "long", 30),
        bet("Nimbus Labs", "nimbus.example", "short", 20),
      ]),
  ...
  thesisCase({
    id: "thesis-sm",
    label: "Short",
    note: "hero size, two lines, no avatar so the name leads",
    startup: OPENAI,
    text: TEXT.sm,
    username: "alice",
    pulse: 70,
  ...
  thesisCase({
    id: "thesis-xl",
    label: "Very long",
    note: "smallest size, trimmed with an ellipsis",
    startup: CURSOR,
    text: TEXT.xl,
    username: "alice",
    pulse: 70,
  ...
  thesisCase({
    id: "thesis-xxl",
    label: "Wall of text",
    note: "clipped with an ellipsis at the smallest size",
    startup: PERPLEXITY,
    text: TEXT.xxl,
    username: "alice",
    pulse: 31,
  ...
  thesisCase({
    id: "thesis-no-side",
    label: "No position",
    note: "comment without a stance: reads as 'on', grey bar",
    startup: CURSOR,
    text: TEXT.md,
    username: "lurker",
    pulse: 70,
  ...
  thesisCase({
    id: "thesis-paragraphs",
    label: "Line breaks",
    note: "numbered list with blank lines",
    startup: MISTRAL,
  ...
  thesisCase({
    id: "thesis-emoji",
    label: "Emoji",
    note: "emoji come from twemoji, fetched at render time",
    startup: CURSOR,
    text: TEXT.emoji,
    username: "mantegna",
    pulse: 70,
  ...
  thesisCase({
    id: "thesis-cyrillic",
    label: "Cyrillic",
    note: "latin-only fonts, falls back to a fetched Noto subset",
    startup: MISTRAL,
    text: TEXT.cyrillic,
    username: "erin",
    pulse: 62,
  ...
  thesisCase({
    ...
    note: "a long URL inside the take",
    startup: OPENAI,
    text: TEXT.url,
    username: "alice",
    pulse: 70,
