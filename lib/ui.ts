...
export const qty = "block w-24 border border-line bg-transparent px-2.5 py-2 font-sans text-base text-ink tabular-nums";
...
export const btn = `flex w-fit min-h-10 items-center bg-transparent px-0 py-2 font-sans text-base text-ink underline decoration-1 underline-offset-[0.12em] ${tap} hover:opacity-70 hover:no-underline disabled:cursor-not-allowed disabled:opacity-40 disabled:no-underline`;

export const ghost = `inline-flex min-h-10 items-center bg-transparent px-0 py-2 font-sans text-base text-mute ${tap} hover:text-ink hover:no-underline`;
...
export const stance = `min-h-10 border px-3.5 py-1.5 font-sans ${tap} hover:no-underline`;

export const closeBtn = `inline-flex min-h-10 shrink-0 items-center bg-transparent px-0 py-2 font-sans text-base text-mute underline decoration-1 underline-offset-[0.12em] ${tap} hover:text-ink hover:opacity-70 hover:no-underline disabled:cursor-not-allowed disabled:opacity-40 disabled:no-underline`;
